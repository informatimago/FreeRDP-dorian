...
//static _DomainParameters DomainParameters;


ASN1EXP int    ASN1CALL decode_DomainParameters(const unsigned char *, size_t, _DomainParameters *, size_t *);
ASN1EXP int    ASN1CALL encode_DomainParameters(unsigned char *, size_t, const _DomainParameters *, size_t *);
ASN1EXP size_t ASN1CALL length_DomainParameters(const _DomainParameters *);
ASN1EXP int    ASN1CALL copy_DomainParameters  (const _DomainParameters *, _DomainParameters *);
ASN1EXP void   ASN1CALL free_DomainParameters  (_DomainParameters *);
